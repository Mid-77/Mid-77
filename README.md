...
- [ ] Vertiefung der Kenntnisse in **Python, JS , JAVA**. 
- [ ] Vertiefung in Modern Backend Architecture **NodeJS, Express, PostgreeSQL**.
...
- **Web & Databases:** HTML, CSS, JS(ES2026+), TypeScript, SQL (PostgreSQL), NoSQL (MongoDB). 
- **Methodologies:** Git, Docker, Scrum(Certified), ITIL, Agile, Workflow (n8n).
...
-  **LinkedIn:** https://www.linkedin.com/in/muhammad-ibrahim-danno-214617402
